...
public class CoreDataController
{
    ...
    private lazy var applicationDocumentsDirectory: NSURL = {
        return FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.cyrilchandelier.todo-swift")!
        }() as NSURL
    
    private lazy var managedObjectModel: NSManagedObjectModel = {
        // The managed object model for the application. This property is not optional. It is a fatal error for the application not to be able to find and load its model.
        let modelURL = Bundle.main.url(forResource: "TodoSwift", withExtension: "momd")!
    ...
    private lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        do {
            ...
            if let _ = ProcessInfo.processInfo.environment["UITests"] {
